...
func (c *libraryServiceClient) AddBook(ctx context.Context, in *AddBookRequest, opts ...grpc.CallOption) (*AddBookResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/protos.LibraryService/AddBook", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *libraryServiceClient) SearchBook(ctx context.Context, in *SearchBookRequest, opts ...grpc.CallOption) (*SearchBookResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/protos.LibraryService/SearchBook", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *libraryServiceClient) BorrowBook(ctx context.Context, in *BorrowBookRequest, opts ...grpc.CallOption) (*BorrowBookResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/protos.LibraryService/BorrowBook", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LibraryService_AddBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.LibraryService/AddBook",
	}
...
func _LibraryService_SearchBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.LibraryService/SearchBook",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LibraryService_BorrowBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.LibraryService/BorrowBook",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
