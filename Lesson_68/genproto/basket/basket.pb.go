...
func (x *Quantity) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
var file_basket_proto_rawDesc = []byte{
	...
	0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x5e, 0x0a, 0x08, 0x51, 0x75, 0x61, 0x6e, 0x74,
	0x69, 0x74, 0x79, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01,
	...
	0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x22, 0x3d, 0x0a, 0x03, 0x49, 0x64, 0x73, 0x12, 0x17,
	0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	0x69, 0x64, 0x32, 0xc2, 0x01, 0x0a, 0x06, 0x42, 0x61, 0x73, 0x6b, 0x65, 0x74, 0x12, 0x2e, 0x0a,
	...
	,
}
...
var file_basket_proto_goTypes = []interface{}{
	...
	(*Id)(nil),         // 1: basket.Id
	(*Quantity)(nil),   // 2: basket.Quantity
	(*Ids)(nil),        // 3: basket.Ids
	(*Product)(nil),    // 4: basket.Product
	(*Products)(nil),   // 5: basket.Products
	(*Void)(nil),       // 6: basket.Void
}
var file_basket_proto_depIdxs = []int32{
	4, // 0: basket.Products.items:type_name -> basket.Product
	0, // 1: basket.Basket.AddProduct:input_type -> basket.NewProduct
	1, // 2: basket.Basket.GetProducts:input_type -> basket.Id
	2, // 3: basket.Basket.UpdateProduct:input_type -> basket.Quantity
	3, // 4: basket.Basket.RemoveProduct:input_type -> basket.Ids
	6, // 5: basket.Basket.AddProduct:output_type -> basket.Void
	5, // 6: basket.Basket.GetProducts:output_type -> basket.Products
	6, // 7: basket.Basket.UpdateProduct:output_type -> basket.Void
	6, // 8: basket.Basket.RemoveProduct:output_type -> basket.Void
