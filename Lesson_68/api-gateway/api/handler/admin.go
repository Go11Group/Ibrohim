...
func (h *Handler) AddUser(c *gin.Context) {
	...
	resp, err := h.Admin.AddUser(ctx, &req)
	if err != nil {
...
func (h *Handler) GetUser(c *gin.Context) {
	...
	resp, err := h.Admin.GetUser(ctx, &pb.ID{Id: id})
	if err != nil {
...
func (h *Handler) UpdateUser(c *gin.Context) {
	...
	resp, err := h.Admin.UpdateUser(ctx, &pb.NewData{
		Id:          id,
...
func (h *Handler) DeleteUser(c *gin.Context) {
	...
	_, err = h.Admin.DeleteUser(ctx, &pb.ID{Id: id})
	if err != nil {
