...
// CRUD operations
func (e *EnrollmentRepo) EnrollUserToCourse(newData model.Enrollment) error {
...
func (e *EnrollmentRepo) Update(enrollmentID string, newData model.Enrollment) error {
	...
	filter = append(filter, "updated_at = :updated_at where enrollment_id = :enrollment_id and deleted_at = 0")
