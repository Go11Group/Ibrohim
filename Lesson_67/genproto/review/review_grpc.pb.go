...
type ReviewesClient interface {
	CreateReview(ctx context.Context, in *Review, opts ...grpc.CallOption) (*Id, error)
...
func (c *reviewesClient) CreateReview(ctx context.Context, in *Review, opts ...grpc.CallOption) (*Id, error) {
	out := new(Id)
...
func (c *reviewesClient) UpdateReview(ctx context.Context, in *Review, opts ...grpc.CallOption) (*Review, error) {
	out := new(Review)
...
type ReviewesServer interface {
	CreateReview(context.Context, *Review) (*Id, error)
...
func (UnimplementedReviewesServer) CreateReview(context.Context, *Review) (*Id, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateReview not implemented")
}
func (UnimplementedReviewesServer) UpdateReview(context.Context, *Review) (*Review, error) {
...
func _Reviewes_CreateReview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReviewesServer).CreateReview(ctx, req.(*Review))
	}
...
func _Reviewes_UpdateReview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReviewesServer).UpdateReview(ctx, req.(*Review))
	}
	return interceptor(ctx, in, info, handler)
}
