...
type TransportServiceClient interface {
	GetBusSchedule(ctx context.Context, in *Number, opts ...grpc.CallOption) (*Schedule, error)
	TrackBusLocation(ctx context.Context, in *Number, opts ...grpc.CallOption) (*GPS, error)
	ReportTrafficJam(ctx context.Context, in *Route, opts ...grpc.CallOption) (*Traffic, error)
}
...
func (c *transportServiceClient) GetBusSchedule(ctx context.Context, in *Number, opts ...grpc.CallOption) (*Schedule, error) {
	out := new(Schedule)
...
func (c *transportServiceClient) TrackBusLocation(ctx context.Context, in *Number, opts ...grpc.CallOption) (*GPS, error) {
	out := new(GPS)
...
func (c *transportServiceClient) ReportTrafficJam(ctx context.Context, in *Route, opts ...grpc.CallOption) (*Traffic, error) {
	out := new(Traffic)
...
type TransportServiceServer interface {
	GetBusSchedule(context.Context, *Number) (*Schedule, error)
	TrackBusLocation(context.Context, *Number) (*GPS, error)
	ReportTrafficJam(context.Context, *Route) (*Traffic, error)
...
func (UnimplementedTransportServiceServer) GetBusSchedule(context.Context, *Number) (*Schedule, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBusSchedule not implemented")
}
func (UnimplementedTransportServiceServer) TrackBusLocation(context.Context, *Number) (*GPS, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TrackBusLocation not implemented")
}
func (UnimplementedTransportServiceServer) ReportTrafficJam(context.Context, *Route) (*Traffic, error) {
...
func _TransportService_ReportTrafficJam_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransportServiceServer).ReportTrafficJam(ctx, req.(*Route))
	}
	return interceptor(ctx, in, info, handler)
}
