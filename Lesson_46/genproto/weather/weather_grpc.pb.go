...
type WeatherServiceClient interface {
	GetCurrentWeather(ctx context.Context, in *Place, opts ...grpc.CallOption) (*Weather, error)
	GetWeatherForecast(ctx context.Context, in *Forecast, opts ...grpc.CallOption) (*Weather, error)
	ReportWeatherCondition(ctx context.Context, in *Place, opts ...grpc.CallOption) (*WeatherType, error)
}
...
func (c *weatherServiceClient) GetCurrentWeather(ctx context.Context, in *Place, opts ...grpc.CallOption) (*Weather, error) {
	out := new(Weather)
	err := c.cc.Invoke(ctx, "/protos.WeatherService/GetCurrentWeather", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *weatherServiceClient) GetWeatherForecast(ctx context.Context, in *Forecast, opts ...grpc.CallOption) (*Weather, error) {
	out := new(Weather)
	err := c.cc.Invoke(ctx, "/protos.WeatherService/GetWeatherForecast", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *weatherServiceClient) ReportWeatherCondition(ctx context.Context, in *Place, opts ...grpc.CallOption) (*WeatherType, error) {
	out := new(WeatherType)
	err := c.cc.Invoke(ctx, "/protos.WeatherService/ReportWeatherCondition", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WeatherServiceServer interface {
	GetCurrentWeather(context.Context, *Place) (*Weather, error)
	GetWeatherForecast(context.Context, *Forecast) (*Weather, error)
	ReportWeatherCondition(context.Context, *Place) (*WeatherType, error)
...
func (UnimplementedWeatherServiceServer) GetCurrentWeather(context.Context, *Place) (*Weather, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCurrentWeather not implemented")
}
func (UnimplementedWeatherServiceServer) GetWeatherForecast(context.Context, *Forecast) (*Weather, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetWeatherForecast not implemented")
}
func (UnimplementedWeatherServiceServer) ReportWeatherCondition(context.Context, *Place) (*WeatherType, error) {
...
func _WeatherService_GetCurrentWeather_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.WeatherService/GetCurrentWeather",
	}
...
func _WeatherService_GetWeatherForecast_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.WeatherService/GetWeatherForecast",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _WeatherService_ReportWeatherCondition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.WeatherService/ReportWeatherCondition",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
